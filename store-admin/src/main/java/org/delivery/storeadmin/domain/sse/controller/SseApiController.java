...
public class SseApiController {
    ...
    public ResponseBodyEmitter connect(
        ...
        var userSseConncetion = UserSseConnection.connect(
                userSession.getStoreId().toString(),
                sseConnectionPool,
                objectMapper
        );

        sseConnectionPool.addSession(userSseConncetion.getUniqueKey(), userSseConncetion);

        return userSseConncetion.getSseEmitter();
    }
