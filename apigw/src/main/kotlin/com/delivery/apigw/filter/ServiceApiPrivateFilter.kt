    ...
    override fun apply(config: Config): GatewayFilter {
        ...
        return GatewayFilter { exchange, chain ->
            ...
            val token = if(headers.isEmpty()){
                throw ApiException(TokenErrorCode.TOKEN_NOT_FOUND)
            } else {
                headers.get(0)
            }
            ...
            webClient
                ...
                .flatMap { response ->
                    ...
                    val proxyResquest = exchange.request.mutate()
                        .header("x-user-id", userId)
                        .build()

                    val requestBuild = exchange.mutate().request(proxyResquest).build()
